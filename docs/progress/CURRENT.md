...
- **Last completed:** P1 — Track world → [`docs/progress/P1-track-world.md`](P1-track-world.md)
- **Next up:** P2 (scope not yet spec'd or planned — see `docs/superpowers/specs/2026-08-21-m2-the-show-roadmap.md` §P2)
